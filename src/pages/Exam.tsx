...
const examData: Record<string, any[]> = {
  "security-plus": [
    ...
    { question: "An organization wants to implement a security control that will protect against unauthorized physical access. Which of the following would be MOST effective?", options: ["Biometric authentication system", "Password complexity requirements", "Intrusion detection system", "Data loss prevention software"], correct: 0, difficulty: "easy", category: "Physical Security", explanation: "Biometric authentication systems like fingerprint or facial recognition are the most effective for physical access control because they verify 'something you are', which cannot be easily shared or stolen. Password complexity and IDS are for logical security, and DLP is for data protection." },
    { question: "A security analyst discovers that an attacker has been using stolen credentials. Which type of attack is this?", options: ["Man-in-the-middle", "Credential harvesting", "SQL injection", "Cross-site scripting"], correct: 1, difficulty: "medium", category: "Attack Types", explanation: "Credential harvesting is the process of stealing login credentials through phishing, keylogging, or database breaches. Man-in-the-middle intercepts communications, while SQL injection and XSS exploit web application vulnerabilities." },
    { question: "Which of the following BEST describes defense in depth?", options: ["Using a single strong security control", "Implementing multiple layers of security controls", "Focusing only on perimeter security", "Relying on endpoint protection only"], correct: 1, difficulty: "hard", category: "Security Architecture", explanation: "Defense in depth is a layered security approach using multiple security controls so that if one fails, others still provide protection. Single controls or focusing on one area leaves the system vulnerable if that control is bypassed." },
    { question: "What type of malware can replicate itself without user interaction?", options: ["Trojan", "Worm", "Virus", "Adware"], correct: 1, difficulty: "easy", category: "Malware", explanation: "Worms can self-replicate and spread across networks automatically without user interaction. Viruses require host files and user action to spread, while Trojans disguise themselves as legitimate software." },
    { question: "Which attack involves overwhelming a system with traffic to make it unavailable?", options: ["Phishing", "DDoS", "SQL Injection", "Buffer Overflow"], correct: 1, difficulty: "easy", category: "Attack Types", explanation: "DDoS (Distributed Denial of Service) attacks flood a system with traffic from multiple sources to make it unavailable. Phishing targets users, SQL injection exploits databases, and buffer overflows exploit memory vulnerabilities." },
    { question: "What is the primary purpose of encryption?", options: ["Authentication", "Confidentiality", "Availability", "Non-repudiation"], correct: 1, difficulty: "easy", category: "Cryptography", explanation: "Encryption's primary purpose is confidentiality - protecting data from unauthorized access by converting it into unreadable ciphertext. Authentication verifies identity, availability ensures access, and non-repudiation prevents denial of actions." },
    { question: "Which protocol provides secure remote access to network devices?", options: ["Telnet", "SSH", "FTP", "SMTP"], correct: 1, difficulty: "easy", category: "Network Security", explanation: "SSH (Secure Shell) provides encrypted remote access to network devices on port 22. Telnet sends data in plaintext, FTP is for file transfers, and SMTP is for email." },
    { question: "What does a digital signature provide?", options: ["Confidentiality only", "Integrity and authentication", "Availability", "Encryption"], correct: 1, difficulty: "medium", category: "Cryptography", explanation: "Digital signatures provide integrity (data hasn't been modified) and authentication (verifies sender identity) through asymmetric cryptography. They don't provide confidentiality or encryption of the message content." },
    { question: "Which type of attack targets web applications by injecting malicious scripts?", options: ["SQL Injection", "XSS", "CSRF", "Buffer Overflow"], correct: 1, difficulty: "medium", category: "Web Security", explanation: "XSS (Cross-Site Scripting) injects malicious scripts into web pages viewed by other users. SQL Injection targets databases, CSRF tricks users into unwanted actions, and buffer overflows exploit memory." },
    { question: "What is the difference between symmetric and asymmetric encryption?", options: ["Speed of encryption", "Number of keys used", "Level of security", "Type of algorithm"], correct: 1, difficulty: "medium", category: "Cryptography", explanation: "The key difference is the number of keys: symmetric uses one shared key for encryption and decryption, while asymmetric uses a public/private key pair. Symmetric is faster but key distribution is challenging." },
    { question: "Which of the following is a characteristic of a zero-day exploit?", options: ["It has been patched", "No fix is available", "It only works on old systems", "It requires physical access"], correct: 1, difficulty: "hard", category: "Vulnerabilities", explanation: "A zero-day exploit targets a vulnerability that is unknown to the vendor and has no available patch or fix. 'Zero-day' refers to the vendor having zero days to fix it before it's exploited." },
    { question: "What is the purpose of a honeypot?", options: ["Block all attacks", "Attract and analyze attackers", "Encrypt data", "Manage passwords"], correct: 1, difficulty: "medium", category: "Security Tools", explanation: "Honeypots are decoy systems designed to attract attackers and analyze their methods without risking production systems. They don't block attacks directly but provide valuable intelligence about attack techniques." },
    { question: "Which authentication factor is 'something you are'?", options: ["Password", "Smart card", "Fingerprint", "PIN"], correct: 2, difficulty: "easy", category: "Authentication", explanation: "Biometric factors like fingerprints, facial recognition, and iris scans are 'something you are'. Passwords and PINs are 'something you know', and smart cards are 'something you have'." },
    { question: "What does MFA stand for?", options: ["Multiple Factor Authentication", "Multi-Factor Authentication", "Mandatory Factor Authentication", "Maximum Factor Authentication"], correct: 1, difficulty: "easy", category: "Authentication", explanation: "MFA stands for Multi-Factor Authentication, which requires two or more different types of authentication factors (something you know, have, or are) to verify identity." },
    { question: "Which protocol is used for secure email transmission?", options: ["HTTP", "FTP", "S/MIME", "SNMP"], correct: 2, difficulty: "medium", category: "Cryptography", explanation: "S/MIME (Secure/Multipurpose Internet Mail Extensions) provides encryption and digital signatures for email. HTTP is for web, FTP for files, and SNMP for network management." },
    { question: "What is the primary goal of risk management?", options: ["Eliminate all risks", "Reduce risk to acceptable levels", "Transfer all risks", "Ignore minor risks"], correct: 1, difficulty: "medium", category: "Risk Management", explanation: "Risk management aims to reduce risks to acceptable levels that balance security with business needs and costs. Eliminating all risks is impossible and would be too expensive; transferring or ignoring risks isn't always appropriate." },
    { question: "Which attack involves tricking users into revealing sensitive information?", options: ["DDoS", "Phishing", "SQL Injection", "Buffer Overflow"], correct: 1, difficulty: "easy", category: "Social Engineering", explanation: "Phishing is a social engineering attack that tricks users into revealing sensitive information like passwords or credit card numbers through fake emails, websites, or messages. DDoS disrupts services, SQL injection exploits databases, and buffer overflows exploit memory." },
    { question: "What is the principle of least privilege?", options: ["Give users maximum access", "Grant minimum necessary access", "Allow access to everything", "Restrict all access"], correct: 1, difficulty: "easy", category: "Access Control", explanation: "The principle of least privilege means granting users only the minimum access rights necessary to perform their job functions. This limits potential damage from accidents or compromised accounts while still allowing users to work effectively." },
    { question: "Which type of backup copies only changed files since the last full backup?", options: ["Full", "Incremental", "Differential", "Mirror"], correct: 2, difficulty: "medium", category: "Business Continuity", explanation: "Differential backups copy all files changed since the last full backup. Incremental backups only copy files changed since the last backup of any type, full backups copy everything, and mirror backups create an exact copy." },
    { question: "What does IDS stand for?", options: ["Internet Detection System", "Intrusion Detection System", "Internal Defense System", "Information Defense System"], correct: 1, difficulty: "easy", category: "Security Tools", explanation: "IDS stands for Intrusion Detection System, which monitors network or system activities for malicious activities or policy violations and sends alerts when detected." },
    { question: "Which security model focuses on data confidentiality?", options: ["Bell-LaPadula", "Biba", "Clark-Wilson", "Brewer-Nash"], correct: 0, difficulty: "hard", category: "Security Models", explanation: "Bell-LaPadula model focuses on data confidentiality with 'no read up, no write down' rules. Biba focuses on integrity, Clark-Wilson on integrity and transactions, and Brewer-Nash prevents conflicts of interest." },
    { question: "What is the purpose of a VPN?", options: ["Speed up internet", "Create secure tunnel", "Block malware", "Scan for viruses"], correct: 1, difficulty: "easy", category: "Network Security", explanation: "A VPN (Virtual Private Network) creates an encrypted tunnel over a public network to securely transmit data between locations. It doesn't speed up internet, block malware directly, or scan for viruses." },
    { question: "Which port does HTTPS use by default?", options: ["80", "443", "8080", "22"], correct: 1, difficulty: "easy", category: "Network Security", explanation: "HTTPS uses port 443 by default. Port 80 is for HTTP, 8080 is an alternate HTTP port, and 22 is for SSH." },
    { question: "What is a rootkit?", options: ["Antivirus software", "Malware with elevated privileges", "Network scanner", "Firewall rule"], correct: 1, difficulty: "medium", category: "Malware", explanation: "A rootkit is malicious software designed to hide its presence and gain elevated (root/administrator) privileges on a system, making it difficult to detect and remove." },
    { question: "Which attack exploits trust relationships between systems?", options: ["Privilege escalation", "Lateral movement", "Initial access", "Exfiltration"], correct: 1, difficulty: "medium", category: "Attack Types", explanation: "Lateral movement exploits trust relationships between systems to move through a network after initial compromise. Privilege escalation gains higher permissions, initial access is entry, and exfiltration is data theft." },
    { question: "What does PKI stand for?", options: ["Public Key Infrastructure", "Private Key Infrastructure", "Protected Key Infrastructure", "Primary Key Infrastructure"], correct: 0, difficulty: "medium", category: "Cryptography", explanation: "PKI stands for Public Key Infrastructure, which is a framework of policies, technologies, and services that manages digital certificates and public-key encryption." },
    { question: "Which protocol is used for network time synchronization?", options: ["NTP", "SNMP", "DNS", "DHCP"], correct: 0, difficulty: "medium", category: "Network Protocols", explanation: "NTP (Network Time Protocol) synchronizes clocks across network systems. SNMP manages network devices, DNS resolves domain names, and DHCP assigns IP addresses." },
    { question: "What is the purpose of security awareness training?", options: ["Technical skills", "Reduce human risk", "Install software", "Configure firewalls"], correct: 1, difficulty: "easy", category: "Security Awareness", explanation: "Security awareness training aims to reduce human risk by educating users about security threats, policies, and best practices. It's not primarily for technical skills, software installation, or firewall configuration." },
    { question: "Which type of fire suppression is safe for electronic equipment?", options: ["Water", "Foam", "FM-200", "Chemical powder"], correct: 2, difficulty: "medium", category: "Physical Security", explanation: "FM-200 (and similar clean agents) is safe for electronic equipment as it doesn't leave residue and doesn't conduct electricity. Water, foam, and chemical powder can damage electronics." },
    { question: "What is a SQL injection attack?", options: ["Network flood", "Database query exploit", "Email scam", "Physical breach"], correct: 1, difficulty: "medium", category: "Web Security", explanation: "SQL injection is an attack that exploits vulnerabilities in database queries by injecting malicious SQL code. It's not a network flood, email scam, or physical breach." },
    { question: "Which encryption standard replaced DES?", options: ["3DES", "AES", "RSA", "RC4"], correct: 1, difficulty: "medium", category: "Cryptography", explanation: "AES (Advanced Encryption Standard) replaced DES as the U.S. government standard. 3DES was a temporary solution, RSA is asymmetric encryption, and RC4 is a stream cipher." },
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-4 mt-8">
                  {filteredQuestions.map((q, index) => {
                    ...
                    return (
                      <div key={index} className={`p-4 border-2 rounded-lg ${!isCorrect ? 'border-orange-300 bg-orange-50 dark:bg-orange-950' : 'border-border'}`}>
